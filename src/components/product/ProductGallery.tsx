...
export const ProductGallery = memo(function ProductGallery({
  ...
  const isPrimaryImage = activeIndex === 0 && angleIndex === 0;
      ...
      >
        {showFallback ? (
          ...
          <Image
            ...
            loading={isPrimaryImage ? undefined : "lazy"}
            sizes="(max-width: 1024px) 100vw, 560px"
            placeholder="empty"
            className={`object-contain object-center p-6 shop-image-seamless md:p-8 transition-transform duration-200 ease-out ${
