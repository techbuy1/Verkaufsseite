...
export const PRODUCT_IMAGE_REGISTRY: Record<string, RegistryColorEntry[]> = {
  "iphone-17-pro": [
    {
      ...
      name: "Cosmic Orange",
      hex: "#e8622a",
      file: "images/products/iphone-17-pro/cosmic-orange/front.webp",
      angles: ["images/products/iphone-17-pro/cosmic-orange/back.webp"],
    ...
    },
    {
      ...
      name: "Deep Blue",
      hex: "#2f3b52",
      file: "images/products/iphone-17-pro/deep-blue/front.webp",
      angles: ["images/products/iphone-17-pro/deep-blue/back.webp"],
    ...
    },
    {
      ...
      name: "Silver",
      hex: "#e3e4e5",
      file: "images/products/iphone-17-pro/silver/front.webp",
      angles: ["images/products/iphone-17-pro/silver/back.webp"],
      wallpaper: "images/products/Apple/iPhone-17-Pro-wallpapers/silver.png",
  ...
  "iphone-17-pro-max": [
    {
      ...
      name: "Cosmic Orange",
      hex: "#e8622a",
      file: "images/products/iphone-17-pro-max/cosmic-orange/front.webp",
      angles: ["images/products/iphone-17-pro-max/cosmic-orange/back.webp"],
    },
    {
      id: "deep-blue",
      name: "Deep Blue",
      hex: "#2f3b52",
      file: "images/products/iphone-17-pro-max/deep-blue/front.webp",
      angles: ["images/products/iphone-17-pro-max/deep-blue/back.webp"],
    },
    {
      id: "silver",
      name: "Silver",
      hex: "#e3e4e5",
      file: "images/products/iphone-17-pro-max/silver/front.webp",
      angles: ["images/products/iphone-17-pro-max/silver/back.webp"],
    },
  ],
  "iphone-17": [
    { id: "black", name: "Schwarz", hex: "#1d1d1f", file: `${IPHONE_17}/iPhone 17 /iPhone_17_Black.png`, angles: [`${IPHONE_17}/iPhone 17 /iPhone_17_Schwarz_Rueckseite.png`] },
    { id: "white", name: "Weiß", hex: "#f5f5f7", file: `${IPHONE_17}/iPhone 17 /iPhone_17_white.png`, angles: [`${IPHONE_17}/iPhone 17 /iPhone_17_Weiss_Rueckseite_Freigestellt.png`] },
    { id: "lavender", name: "Lavendel", hex: "#b8a9c9", file: `${IPHONE_17}/iPhone 17 /iPhone_17_Lavendel.png`, angles: [`${IPHONE_17}/iPhone 17 /iPhone_17_Lavendel_Rueckseite_Freigestellt.png`] },
    { id: "mist-blue", name: "Mist Blue", hex: "#9ec5e8", file: `${IPHONE_17}/iPhone 17 /iPhone_17_Mist_Blue.png`, angles: [`${IPHONE_17}/iPhone 17 /iPhone_17_Mist_Blue_Rueckseite_Freigestellt.png`] },
    { id: "sage-green", name: "Sage Green", hex: "#4f8777", file: `${IPHONE_17}/iPhone 17 /iPhone_17_Sage_Green.png`, angles: [`${IPHONE_17}/iPhone 17 /iPhone_17_Sage_Green_Rueckseite_Freigestellt.png`] },
  ],
  "iphone-17-air": [
    { id: "black", name: "Schwarz", hex: "#1d1d1f", file: `${IPHONE_17}/iPhone Air /iPhone_Air_Black.png`, angles: [`${IPHONE_17}/iPhone Air /iPhone_17_Air_Space_Schwarz_Rueckseite (1).png`] },
    { id: "sky-blue", name: "Sky Blue", hex: "#7eb6d7", file: `${IPHONE_17}/iPhone Air /iPhone_Air_SkyBlue.png`, angles: [`${IPHONE_17}/iPhone Air /iPhone_17_Air_Himmelblau_Rueckseite.png`] },
    { id: "light-gold", name: "Lichtgold", hex: "#d4a59a", file: `${IPHONE_17}/iPhone Air /apple_iphone_17_air_Lichtgold .png`, angles: [`${IPHONE_17}/iPhone Air /iPhone_17_Air_Lichtgold_Rueckseite.png`] },
  ],
  "iphone-16": [
    { id: "black", name: "Schwarz", hex: "#1d1d1f", file: `${IPHONE_16}/iPhone 16 Normal /iPhone16Black.png`, angles: [`${IPHONE_16}/iPhone 16 Normal /iPhone_16_Schwarz_Rueckseite (1) Kopie.png`] },
    { id: "pink", name: "Pink", hex: "#f2b8c6", file: `${IPHONE_16}/iPhone 16 Normal /iPhone16Pink.png`, angles: [`${IPHONE_16}/iPhone 16 Normal /iPhone_16_Pink_Rueckseite Kopie.png`] },
    { id: "teal", name: "Teal", hex: "#4f8777", file: `${IPHONE_16}/iPhone 16 Normal /iPhone16TealGreen.png`, angles: [`${IPHONE_16}/iPhone 16 Normal /iPhone_16_Blaugruen_Rueckseite Kopie.png`] },
    { id: "ultramarine", name: "Ultramarine", hex: "#4a6fa5", file: `${IPHONE_16}/iPhone 16 Normal /iPhone16Ultramarine.png`, angles: [`${IPHONE_16}/iPhone 16 Normal /iPhone_16_Ultramarin_Rueckseite Kopie.png`] },
    { id: "white", name: "Weiß", hex: "#f5f5f7", file: `${IPHONE_16}/iPhone 16 Normal /iPhone16White.png`, angles: [`${IPHONE_16}/iPhone 16 Normal /iPhone_16_Weiss_Rueckseite Kopie.png`] },
  ],
  "iphone-16-plus": [
    { id: "black", name: "Schwarz", hex: "#1d1d1f", file: `${IPHONE_16}/iPhone 16 Plus /iPhone16PlusBlack Kopie.png`, angles: [`${IPHONE_16}/iPhone 16 Plus /iPhone_16Plus_Schwarz_Rueckseite (1).png`] },
    { id: "pink", name: "Pink", hex: "#f2b8c6", file: `${IPHONE_16}/iPhone 16 Plus /iPhone16PlusPink Kopie.png`, angles: [`${IPHONE_16}/iPhone 16 Plus /iPhone_16Pus_Pink_Rueckseite.png`] },
    { id: "teal", name: "Teal", hex: "#4f8777", file: `${IPHONE_16}/iPhone 16 Plus /iPhone16PlusTealGreen Kopie.png`, angles: [`${IPHONE_16}/iPhone 16 Plus /iPhone_16Plus_Blaugruen_Rueckseite.png`] },
    { id: "ultramarine", name: "Ultramarine", hex: "#4a6fa5", file: `${IPHONE_16}/iPhone 16 Plus /iPhone16PlusUltramarine Kopie.png`, angles: [`${IPHONE_16}/iPhone 16 Plus /iPhone_16Plus_Ultramarin_Rueckseite.png`] },
    { id: "white", name: "Weiß", hex: "#f5f5f7", file: `${IPHONE_16}/iPhone 16 Plus /iPhone16PlusWhite Kopie.png`, angles: [`${IPHONE_16}/iPhone 16 Plus /iPhone_16_PlusWeiss_Rueckseite.png`] },
  ],
  "iphone-16-pro": [
    { id: "titan-black", name: "Titan Schwarz", hex: "#1d1d1f", file: `${IPHONE_16}/iPhone 16 Pro /iPhone_16_Pro_TitanBlack.png`, angles: [`${IPHONE_16}/iPhone 16 Pro /iPhone_16_Pro_Titan_Schwarz_Rueckseite_FullHD.png`] },
    { id: "titan-desert", name: "Titan Wüstensand", hex: "#d4a59a", file: `${IPHONE_16}/iPhone 16 Pro /iPhone_16_Pro_TitanDessert.png`, angles: [`${IPHONE_16}/iPhone 16 Pro /iPhone_16_Pro_Titan_Wuestensand_Rueckseite_FullHD (1).png`] },
    { id: "titan-natural", name: "Titan Natur", hex: "#bfa48a", file: `${IPHONE_16}/iPhone 16 Pro /iPhone_16_Pro_TitanNatur .png`, angles: [`${IPHONE_16}/iPhone 16 Pro /iPhone_16_Pro_Titan_Natur_Rueckseite_FullHD.png`] },
    { id: "titan-silver", name: "Titan Silber", hex: "#e3e4e5", file: `${IPHONE_16}/iPhone 16 Pro /iPhone_16_Pro_TitanSilber .png`, angles: [`${IPHONE_16}/iPhone 16 Pro /iPhone_16_Pro_Titan_Weiss_Rueckseite_FullHD.png`] },
  ],
  "iphone-16-pro-max": [
    { id: "titan-black", name: "Titan Schwarz", hex: "#1d1d1f", file: `${IPHONE_16}/iPhone 16 Pro Max /iPhone_16_Pro_Max_TitanBlack Kopie.png`, angles: [`${IPHONE_16}/iPhone 16 Pro Max /iPhone_16_ProMax_Titan_Schwarz_Rueckseite_FullHD Kopie.png`] },
    { id: "titan-desert", name: "Titan Wüstensand", hex: "#d4a59a", file: `${IPHONE_16}/iPhone 16 Pro Max /iPhone_16_Pro_Max_TitanDessert Kopie.png`, angles: [`${IPHONE_16}/iPhone 16 Pro Max /iPhone_16_ProMax_Titan_Wuestensand_Rueckseite_FullHD (1) Kopie.png`] },
    { id: "titan-natural", name: "Titan Natur", hex: "#bfa48a", file: `${IPHONE_16}/iPhone 16 Pro Max /iPhone_16_Pro_Max_TitanNatur  Kopie.png`, angles: [`${IPHONE_16}/iPhone 16 Pro Max /iPhone_16_ProMax_Titan_Natur_Rueckseite_FullHD Kopie.png`] },
    { id: "titan-silver", name: "Titan Silber", hex: "#e3e4e5", file: `${IPHONE_16}/iPhone 16 Pro Max /iPhone_16_Pro_Max_TitanSilber  Kopie.png`, angles: [`${IPHONE_16}/iPhone 16 Pro Max /iPhone_16_ProMax_Titan_Weiss_Rueckseite_FullHD Kopie.png`] },
  ],
  "iphone-16e": [
    { id: "black", name: "Schwarz", hex: "#1d1d1f", file: `${IPHONE_16}/iPhone 16e /iPhone_16e_Black.png`, angles: [`${IPHONE_16}/iPhone 16e /iPhone_16e_Schwarz_Rueckseite_FullHD.png`] },
    { id: "white", name: "Weiß", hex: "#f5f5f7", file: `${IPHONE_16}/iPhone 16e /iPhone_16e_white.png`, angles: [`${IPHONE_16}/iPhone 16e /iPhone_16e_Weiss_Rueckseite_FullHD.png`] },
  ],
  "iphone-15": [
    { id: "black", name: "Schwarz", hex: "#1d1d1f", file: `${IPHONE_15}/iPhone15_Black.png`, angles: [`${IPHONE_15}/iPhone15_Schwarz_Rueckseite.png`] },
    { id: "blue", name: "Blau", hex: "#4a6fa5", file: `${IPHONE_15}/iPhone15_Blau.png`, angles: [`${IPHONE_15}/iPhone15_Blau_Rueckseite.png`] },
    { id: "yellow", name: "Gelb", hex: "#e8d44a", file: `${IPHONE_15}/iPhone15_Gelb.png`, angles: [`${IPHONE_15}/iPhone15_Gelb_Rueckseite.png`] },
    { id: "green", name: "Grün", hex: "#4f8777", file: `${IPHONE_15}/iPhone15_Grün.png`, angles: [`${IPHONE_15}/iPhone15_Gruen_Rueckseite.png`] },
    { id: "pink", name: "Pink", hex: "#f2b8c6", file: `${IPHONE_15}/iPhone15_Pink.png`, angles: [`${IPHONE_15}/iPhone15_Pink_Rueckseite.png`] },
  ],
  "iphone-15-plus": [
    { id: "black", name: "Schwarz", hex: "#1d1d1f", file: `${IPHONE_15}/iPhone15Plus_Black Kopie.png`, angles: [`${IPHONE_15}/iPhone15Plus_Schwarz_Rueckseite.png`] },
    { id: "blue", name: "Blau", hex: "#4a6fa5", file: `${IPHONE_15}/iPhone15Plus_Blau Kopie.png`, angles: [`${IPHONE_15}/iPhone15Plus_Blau_Rueckseite.png`] },
    { id: "yellow", name: "Gelb", hex: "#e8d44a", file: `${IPHONE_15}/iPhone15Plus_Gelb Kopie.png`, angles: [`${IPHONE_15}/iPhone15Plus_Gelb_Rueckseite.png`] },
    { id: "green", name: "Grün", hex: "#4f8777", file: `${IPHONE_15}/iPhone15Plus_Grün Kopie.png`, angles: [`${IPHONE_15}/iPhone15Plus_Gruen_Rueckseite.png`] },
    { id: "pink", name: "Pink", hex: "#f2b8c6", file: `${IPHONE_15}/iPhone15Plus_Pink Kopie.png`, angles: [`${IPHONE_15}/iPhone15Plus_Pink_Rueckseite.png`] },
  ],
  ...
  "iphone-15-pro": [
    { id: "titan-black", name: "Titan Schwarz", hex: "#1d1d1f", file: `${IPHONE_15}/iPhone15Pro_TitanBlack.png`, angles: [`${IPHONE_15}/iPhone15Pro_Titan_Schwarz_Rueckseite.png`] },
    { id: "titan-blue", name: "Titan Blau", hex: "#4a6fa5", file: `${IPHONE_15}/iPhone15Pro_Titanblau.png`, angles: [`${IPHONE_15}/iPhone15Pro_Titan_Blau_Rueckseite.png`] },
    { id: "titan-natural", name: "Titan Natur", hex: "#bfa48a", file: `${IPHONE_15}/iPhone15Pro_TitanNatur.png`, angles: [`${IPHONE_15}/iPhone15Pro_Titan_Natur_Rueckseite.png`] },
    { id: "titan-white", name: "Titan Weiß", hex: "#f5f5f7", file: `${IPHONE_15}/iPhone15Pro_Titanweiß.png`, angles: [`${IPHONE_15}/iPhone15Pro_Titan_Weiss_Rueckseite.png`] },
  ],
  "iphone-15-pro-max": [
    { id: "titan-black", name: "Titan Schwarz", hex: "#1d1d1f", file: `${IPHONE_15}/iPhone15ProMax_TitanBlack K.png`, angles: [`${IPHONE_15}/iPhone15ProMax_Titan_Schwarz_Rueckseite.png`] },
    { id: "titan-blue", name: "Titan Blau", hex: "#4a6fa5", file: `${IPHONE_15}/iPhone15ProMax_Titanblau.png`, angles: [`${IPHONE_15}/iPhone15ProMax_Titan_Blau_Rueckseite.png`] },
    { id: "titan-natural", name: "Titan Natur", hex: "#bfa48a", file: `${IPHONE_15}/iPhone15ProMax_TitanNatur.png`, angles: [`${IPHONE_15}/iPhone15ProMax_Titan_Natur_Rueckseite.png`] },
    { id: "titan-white", name: "Titan Weiß", hex: "#f5f5f7", file: `${IPHONE_15}/iPhone15ProMax_Titanweiß.png`, angles: [`${IPHONE_15}/iPhone15ProMax_Titan_Weiss_Rueckseite.png`] },
  ],
  "galaxy-s26-ultra": [
    {
      id: "sky-blue",
      name: "Sky Blue",
      hex: "#7eb6d7",
      file: "images/products/galaxy-s26-ultra/sky-blue/front.webp",
      angles: ["images/products/galaxy-s26-ultra/sky-blue/back.webp"],
    ...
    },
    {
      ...
      name: "Pink",
      hex: "#f4b4c4",
      file: "images/products/galaxy-s26-ultra/pink/front.webp",
      angles: ["images/products/galaxy-s26-ultra/pink/back.webp"],
    ...
    },
    {
      ...
      name: "Silber",
      hex: "#d2d2d7",
      file: "images/products/galaxy-s26-ultra/silver/front.webp",
      angles: ["images/products/galaxy-s26-ultra/silver/back.webp"],
    ...
    },
    {
      ...
      name: "Violett",
      hex: "#8b7ab8",
      file: "images/products/galaxy-s26-ultra/violet/front.webp",
      angles: ["images/products/galaxy-s26-ultra/violet/back.webp"],
    ...
    },
    {
      ...
      name: "Weiß",
      hex: "#f5f5f7",
      file: "images/products/galaxy-s26-ultra/white/front.webp",
      angles: ["images/products/galaxy-s26-ultra/white/back.webp"],
    ...
    },
    {
      ...
      name: "Schwarz",
      hex: "#1d1d1f",
      file: "images/products/galaxy-s26-ultra/black/front.webp",
      angles: ["images/products/galaxy-s26-ultra/black/back.webp"],
  ...
  "galaxy-a57": [
    {
      ...
      angles: [`${SAMSUNG_A}/Samsung_Galaxy_A57_Awesome_Navy_Hinten.png`],
    ...
    },
    {
      ...
      angles: [`${SAMSUNG_A}/Samsung_Galaxy_A57_Awesome_Lilac_Hinten.png`],
      wallpaper: `${SAMSUNG_S26_SERIE}/wallpapers/violet.png`,
    },
    {
      id: "icy-blue",
      ...
      angles: [`${SAMSUNG_A}/Samsung_Galaxy_A57_Icy_Blue_Hinten.png`],
      wallpaper: `${SAMSUNG_S26_SERIE}/wallpapers/sky-blue.png`,
    },
    {
      id: "awesome-graphite",
      ...
      angles: [`${SAMSUNG_A}/Samsung_Galaxy_A57_Awesome_Graphite_Hinten.png`],
      wallpaper: `${SAMSUNG_S26_SERIE}/wallpapers/silver.png`,
    },
  ],
  "galaxy-a56": [
    { id: "awesome-olive", name: "Awesome Olive", hex: "#6b7c5c", file: `${SAMSUNG_A}/Samsung_Galaxy_A56_AwesomeOlive.png`, angles: [`${SAMSUNG_A}/Samsung_Galaxy_A56_Awesome_Olive_Hinten.png`] },
    { id: "awesome-pink", name: "Awesome Pink", hex: "#f4b4c4", file: `${SAMSUNG_A}/Samsung_Galaxy_A56_AwesomePink.png`, angles: [`${SAMSUNG_A}/Samsung_Galaxy_A56_Awesome_Pink_Hinten.png`] },
    { id: "awesome-graphite", name: "Awesome Graphite", hex: "#414141", file: `${SAMSUNG_A}/Samsung_Galaxy_A56_AwesomeGraphit.png`, angles: [`${SAMSUNG_A}/Samsung_Galaxy_A56_Awesome_Graphite_Hinten.png`] },
    { id: "awesome-lightgray", name: "Awesome Lightgray", hex: "#d2d2d7", file: `${SAMSUNG_A}/Samsung_Galaxy_A56_AwesomeLightgray.png`, angles: [`${SAMSUNG_A}/Samsung_Galaxy_A56_Awesome_Lightgray_Hinten.png`] },
  ],
  "galaxy-a37": [
    ...
    { id: "awesome-violet", name: "Awesome Violet", hex: "#8b7ab8", file: `${SAMSUNG_A}/Samsung_Galaxy_A37_AwesomeLavendel.png`, angles: [`${SAMSUNG_A}/Samsung_Galaxy_A37_Awesome_Violet_Hinten.png`] },
    { id: "awesome-white", name: "Awesome White", hex: "#f5f5f7", file: `${SAMSUNG_A}/Samsung_Galaxy_A37_AwesomeWhite.png`, angles: [`${SAMSUNG_A}/Samsung_Galaxy_A37_Awesome_White_Hinten.png`] },
  ...
  "galaxy-a27": [
    { id: "black", name: "Black", hex: "#1d1d1f", file: `${SAMSUNG_A}/Samsung_Galaxy_A27_Black.png`, angles: [`${SAMSUNG_A}/Samsung_Galaxy_A27_Black_Hinten.png`] },
    { id: "blue", name: "Blue", hex: "#4a6fa5", file: `${SAMSUNG_A}/Samsung_Galaxy_A27_Blue.png`, angles: [`${SAMSUNG_A}/Samsung_Galaxy_A27_Blue_Hinten.png`] },
    { id: "pink", name: "Pink", hex: "#f4b4c4", file: `${SAMSUNG_A}/Samsung_Galaxy_a27_Pink.png`, angles: [`${SAMSUNG_A}/Samsung_Galaxy_A27_Pink_Hinten.png`] },
  ],
  "galaxy-a26": [
    { id: "black", name: "Black", hex: "#1d1d1f", file: `${SAMSUNG_A}/samsung_galaxy_a26_Black.png`, angles: [`${SAMSUNG_A}/Samsung_Galaxy_A26_Black_Hinten.png`] },
    { id: "mint", name: "Mint", hex: "#a8dcc8", file: `${SAMSUNG_A}/Samsung_Galaxy_a26_mint .png`, angles: [`${SAMSUNG_A}/Samsung_Galaxy_A26_Mint_Hinten.png`] },
    { id: "white", name: "White", hex: "#f5f5f7", file: `${SAMSUNG_A}/Samsung_Galaxy_a26_white.png`, angles: [`${SAMSUNG_A}/Samsung_Galaxy_A26_White_Hinten.png`] },
  ],
  "galaxy-a17": [
    { id: "black", name: "Black", hex: "#1d1d1f", file: `${SAMSUNG_A}/Samsung_Galaxy_A17_Black.png`, angles: [`${SAMSUNG_A}/Samsung_Galaxy_A17_Black_Hinten.png`] },
    { id: "gray", name: "Gray", hex: "#b8b8bd", file: `${SAMSUNG_A}/Samsung_Galaxy_A17_Lightgrey.png`, angles: [`${SAMSUNG_A}/Samsung_Galaxy_A17_Gray_Hinten.png`] },
    { id: "blue", name: "Blue", hex: "#4a6fa5", file: `${SAMSUNG_A}/Samsung_Galaxy_a17_Blau.png`, angles: [`${SAMSUNG_A}/Samsung_Galaxy_A17_Blue_Hinten.png`] },
  ],
  ...
  "google-pixel-10": [
    { id: "obsidian", name: "Obsidian", hex: "#1d1d1f", file: `${GOOGLE}/Google Pixel 10/google_pixel_10_ Obsidian.png`, angles: [`${GOOGLE}/Google Pixel 10/Google_Pixel_10_Obsidian_Hinten.png`] },
    { id: "indigo-blue", name: "Indigo Blue", hex: "#4a6fa5", file: `${GOOGLE}/Google Pixel 10/Google_Pixel_10_Indigo_Blue .png`, angles: [`${GOOGLE}/Google Pixel 10/Google_Pixel_10_Indigo_Blue_Hinten.png`] },
    { id: "lemon-yellow", name: "Lemon Yellow", hex: "#e8d44a", file: `${GOOGLE}/Google Pixel 10/Google_Pixel_Gelb_Lemonyellow.png`, angles: [`${GOOGLE}/Google Pixel 10/Google_Pixel_10_Lemon_Yellow_Hinten.png`] },
    { id: "frozen-blue", name: "Frozen Blue", hex: "#9ec5e8", file: `${GOOGLE}/Google Pixel 10/Google_Pixel_10_Frozenblau.png`, angles: [`${GOOGLE}/Google Pixel 10/Google_Pixel_10_Frozen_Blue_Hinten.png`] },
  ],
  "google-pixel-10-pro": [
    { id: "obsidian", name: "Obsidian", hex: "#1d1d1f", file: `${GOOGLE}/Google Pixel 10 Pro /pixel_10_pro_Obsidian.png`, angles: [`${GOOGLE}/Google Pixel 10 Pro /Google_Pixel_10_Pro_Obsidian_Hinten.png`] },
    { id: "jade-green", name: "Jade Green", hex: "#5f8f7a", file: `${GOOGLE}/Google Pixel 10 Pro /Google_Pixel_10_Pro_Jadegreen_Grün.png`, angles: [`${GOOGLE}/Google Pixel 10 Pro /Google_Pixel_10_Pro_Jade_Green_Hinten.png`] },
    { id: "moonstone", name: "Moonstone", hex: "#b8b8bd", file: `${GOOGLE}/Google Pixel 10 Pro /Google_Pixel_10_Pro_Monnstone_Grau.png`, angles: [`${GOOGLE}/Google Pixel 10 Pro /Google_Pixel_10_Pro_Moonstone_Hinten.png`] },
    { id: "porcelain", name: "Porcelain", hex: "#f5f5f7", file: `${GOOGLE}/Google Pixel 10 Pro /Google_Pixel_10Pro_ProceLain.png`, angles: [`${GOOGLE}/Google Pixel 10 Pro /Google_Pixel_10_Pro_Porcelain_Hinten.png`] },
  ],
  "google-pixel-10-pro-xl": [
    { id: "obsidian", name: "Obsidian", hex: "#1d1d1f", file: `${GOOGLE}/Google Pixel 10 Pro XL /pixel_10_pro_XL_Obsidian Kopie.png`, angles: [`${GOOGLE}/Google Pixel 10 Pro XL /Google_Pixel_10_Pro_XL_Obsidian_Hinten.png`] },
    { id: "jade-green", name: "Jade Green", hex: "#5f8f7a", file: `${GOOGLE}/Google Pixel 10 Pro XL /Google_Pixel_10_Pro_XL_Jadegreen_Grün Kopie.png`, angles: [`${GOOGLE}/Google Pixel 10 Pro XL /Google_Pixel_10_Pro_XL_Jade_Green_Hinten.png`] },
    { id: "moonstone", name: "Moonstone", hex: "#b8b8bd", file: `${GOOGLE}/Google Pixel 10 Pro XL /Google_Pixel_10_Pro_XL_Monnstone_Grau Kopie.png`, angles: [`${GOOGLE}/Google Pixel 10 Pro XL /Google_Pixel_10_Pro_XL_Moonstone_Hinten.png`] },
    { id: "porcelain", name: "Porcelain", hex: "#f5f5f7", file: `${GOOGLE}/Google Pixel 10 Pro XL /Google_Pixel_10_Pro_XL_ProceLain Kopie.png`, angles: [`${GOOGLE}/Google Pixel 10 Pro XL /Google_Pixel_10_Pro_XL_Porcelain_Hinten.png`] },
  ],
  "google-pixel-10a": [
    { id: "obsidian", name: "Obsidian", hex: "#1d1d1f", file: `${GOOGLE}/Google Pixel 10a/GooglePixel_10a_Obsidian.png`, angles: [`${GOOGLE}/Google Pixel 10a/Google_Pixel_10a_Obsidian_Hinten.png`] },
    { id: "berry", name: "Berry", hex: "#8b3a62", file: `${GOOGLE}/Google Pixel 10a/GooglePixel_10a_Berry .png`, angles: [`${GOOGLE}/Google Pixel 10a/Google_Pixel_10a_Berry_Hinten.png`] },
    { id: "fog-green", name: "Fog Green", hex: "#6b7c5c", file: `${GOOGLE}/Google Pixel 10a/GooglePixel_10a_Foggreen.png`, angles: [`${GOOGLE}/Google Pixel 10a/Google_Pixel_10a_Fog_Green_Hinten.png`] },
    { id: "lavender", name: "Lavender", hex: "#b8a9c9", file: `${GOOGLE}/Google Pixel 10a/GooglePixel_10a_Lavender.png`, angles: [`${GOOGLE}/Google Pixel 10a/Google_Pixel_10a_Lavender_Hinten.png`] },
  ],
  "ipad-air-m3": [
    {
      id: "blue",
